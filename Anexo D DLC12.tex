...
WEIBULL_K = 2.0879
WEIBULL_C = 9.2156    # [m/s], a la altura del centro del rotor
...
# la primera bajo la solicitación completa del DLC 1.1 SIN MAYORAR y la
# segunda con las cargas inerciales como única solicitación, también sin
# mayorar. Su diferencia es la parte que escala con el momento
# aerodinámico. Se calibran sobre cargas características porque en fatiga
# la mayoración se aplica una sola vez, sobre la amplitud de cada ciclo.
SIGMA_1_MAX = 163.399  # [MPa] solicitación completa
...
\begin{pycode}
# fn_k, ft_k son las fuerzas por estación del instante gobernante del
# DLC 1.1 SIN mayorar, es decir las mismas que se aplicaron en las dos
# corridas de calibración del modelo de elementos finitos.
M_res_k = momento_resultante(fn_k, ft_k) / 1000.0     # [kN*m]
...
K_AERO = (SIGMA_1_MAX - SIGMA_IN) / M_res_k           # [MPa/(kN*m)]
\end{pycode}
