...
donde $z_0$ es la longitud de rugosidad de la superficie del mar (medida en metros), $g$ la aceleración de gravedad, la constante de von Kármán $\kappa = 0{,}4$ y la constante de Charnock $A_C$, que la norma fija en $0{,}011$ para mar abierto~\parencite{IEC61400-3-1}. La expresión es implícita, ya que $z_0$ aparece en ambos miembros, y se resuelve por iteración numérica. Con la rugosidad así obtenida, la desviación estándar representativa se calcula según la Ec.~\ref{eq:charnock_sigma}:
