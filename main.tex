...
El emplazamiento clasificó como Clase II\textsubscript{C}, con una velocidad media de $7{,}94$~m/s y turbulencia baja. La turbina alcanzó un coeficiente de potencia de $0{,}42$--$0{,}45$, en el extremo superior de lo reportado para rotores H, y una potencia de $201{,}5$~kW a $12$~m/s, consistente con las máquinas documentadas de escala comparable. Las cargas de diseño fueron $146{,}1$ y $152{,}1$~kN en los DLC 1.1 y 1.3, si bien la mayor tensión correspondió al primero, que gobernó la verificación. La tensión máxima, localizada en las conexiones con los brazos, alcanzó $163{,}4$~MPa frente a una resistencia factoreada de $186{,}2$~MPa, con un factor de reserva de $1{,}14$; la rotación aportó por sí sola el $70\%$ de esa tensión. La verificación de estabilidad arrojó un multiplicador de carga mínimo de $1{,}12$, bajo el umbral normativo de $1{,}30$. Las deflexiones alcanzaron el $1{,}4\%$ de la luz entre conexiones y el daño acumulado por fatiga en 20 años, $D_{20} = 6{,}45 \times 10^{-8}$, quedó muy por debajo del límite unitario.
...
\include{2 Antecedentes Generales}
\include{3 Metodología}
\include{4 Resultados}
\include{5 Conclusiones}

\newpage
\include{Declaracion IA}
...
\include{Anexo A Fuerzas}
\include{Anexo B DLC11}
\include{Anexo C DLC13}
\include{Anexo D DLC12}
\include{Anexo E Fuerzas XY}
