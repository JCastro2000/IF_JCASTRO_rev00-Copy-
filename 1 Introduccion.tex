...
El estudio se limita al análisis estructural de una pala del aerogenerador. La caracterización aerodinámica se restringe al método de vórtices libres (FVW). Conviene distinguir aquí dos dominios que no coinciden. El dominio del \textbf{análisis estructural} comprende únicamente la pala, de modo que quedan fuera de él los brazos de soporte (struts), la torre, el sistema de flotación, el generador y los sistemas de anclaje, que no se verifican. El dominio de la \textbf{simulación aerodinámica} es más amplio, ya que incorpora los brazos y la torre como cuerpos que perturban el flujo incidente sobre la pala, los primeros mediante su arrastre y la segunda mediante su arrastre y la sombra que proyecta, por tratarse de efectos que modifican la carga que la pala recibe y que no cabe despreciar al calcularla. No se aborda, en cambio, el análisis hidrodinámico de la plataforma ni la evaluación de la dinámica acoplada rotor-plataforma.
