...
Las 30 simulaciones correspondientes al DLC 1.3 (ETM, $V = 16$ a $24$~m/s) se procesan según el método de la media de máximos prescrito en la Sección 7.6.2.2 de la norma IEC 61400-1~\parencite{IEC61400-1}. La Tabla~\ref{tab:dlc13_maximos} presenta los máximos observados para cada una de las 6 semillas y la media por velocidad, calculados con la misma definición de $F_{tot}$ de la Ec.~\ref{eq:F_tot}.
