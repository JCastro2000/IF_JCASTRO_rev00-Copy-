...
La carga característica global para un período de retorno de 50 años, esto es, el valor de $F_{max}$ que satisface la Ec.~\ref{eq:fk_criterion_num}, es $F_{tot,k} = 116{,}9$~kN. La carga de diseño para el DLC 1.1 según el Anexo G de IEC 61400-1~\parencite{IEC61400-1} se obtiene aplicando el factor de seguridad parcial $\gamma_f = 1{,}25$, según la Ec.~\ref{eq:Fd_dlc11_res}:
